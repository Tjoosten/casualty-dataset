CREATE TABLE IF NOT EXISTS `Vietnam_casualties` (
  ...
  `birth_date`            VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Member birthdate',
  ...
  `process_dt`            VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Process date',
  `death_dt`              VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Incident or death date',
  ...
  `close_dt`              VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Closure date',
  ...
  `i_status_dt`           VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Incident casualty category date',
...
CREATE TABLE IF NOT EXISTS `All_casualties` (
  `service_number`        VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Service number',
  `c`                     VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Member component code.',
  `ptp`                   VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Person type name code',
  `person_type_name`      VARCHAR(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Person type name',
